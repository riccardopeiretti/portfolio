# Cycling & Sport Analytics

Projects focused on cycling and sports performance, combining data science, machine learning, and human-centered approaches to develop data-driven solutions for athletes.
...
- **Objective:**  
  Design a machine learning-based approach to estimate cyclists' energy expenditure during training sessions using athlete characteristics, historical ride data, and training plans.
...
- **Objective:**  
  Develop a supervised machine learning model, as part of my bachelor's thesis, to predict riders' performance in Tour de France 2023 stages using historical Grand Tour data (2017–2022) and rider/stage characteristics.

- **Outcome:**  
  Implemented and evaluated two XGBoost-based predictive models:
  - **Time prediction model:** achieved strong predictive performance (R² ≈ 0.90) for stage completion times.
  - **Position prediction model:** obtained moderate performance (R² ≈ 0.26), highlighting the complexity of ranking prediction due to tactical and contextual factors.

  The project analyzed challenges related to data quality, race dynamics, injuries, and environmental conditions, proposing future improvements through richer feature integration.
...
- **Objective:**  
  Design and prototype an innovative smart helmet and companion mobile application aimed at improving cyclists' safety through connected technologies.
