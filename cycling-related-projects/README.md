...
- **Objective:** Develop a supervised machine learning model, as part of my bachelor's thesis, to predict riders' results in each stage of the Tour de France 2023, using historical Grand Tour data (2017–2022) and stage/rider characteristics.  
...
- **Achievements:** Implemented and evaluated two predictive models with XGBoost:  
  ...
  The thesis identified major challenges (data quality, tactics, injuries, weather) and proposed improvements through richer feature integration. The theis is written in Italian; however, an English version of the abstract is available [ here ](Predictive_Model_for_Cycling_abstract.pdf). 
